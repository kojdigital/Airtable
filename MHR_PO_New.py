...
def airtable_patch():
    ...
    all_records_url = 'https://api.airtable.com/v0/appcheD4BtfvJHmpI/PRODUCTS?view=PO%20TRACKER%20VIEW'
    ...
    while offset is not None : 
        ...
        offset_records_url = 'https://api.airtable.com/v0/appcheD4BtfvJHmpI/PRODUCTS?view=PO%20TRACKER%20VIEW&offset={}'.format(offset)
        # airtable_parameters = { 'Authorization' : 'Bearer {}'.format(airtable_api_key), 'Content-Type' : 'application/json'}
